// To parse this data:
//
//   import { Convert, ContactPageRes } from "./file";
//
//   const welcome = Convert.toContactPageRes(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ContactPageRes {
  data: ContactPageResData;
  meta: Meta;
}

export interface ContactPageResData {
  id: number;
...
export class Convert {
  public static toContactPageRes(json: string): ContactPageRes {
    return cast(JSON.parse(json), r("ContactPageRes"));
  }

  public static welcomeToJson(value: ContactPageRes): string {
    return JSON.stringify(uncast(value, r("ContactPageRes")), null, 2);
  }
}
...
const typeMap: any = {
  ContactPageRes: o(
    [
      { json: "data", js: "data", typ: r("ContactPageResData") },
      { json: "meta", js: "meta", typ: r("Meta") },
    ],
    false
  ),
  ContactPageResData: o(
    [
      { json: "id", js: "id", typ: 0 },
      { json: "attributes", js: "attributes", typ: r("ContactPage") },
    ],
    false
  ),
  ContactPage: o(
