// To parse this data:
//
//   import { Convert, WorksRes } from "./file";
//
//   const welcome = Convert.toWorksRes(json);
//
...
export class Convert {
	public static toWorksRes(json: string): WorksRes {
		return cast(JSON.parse(json), r('WorksRes'));
	}

	public static welcomeToJson(value: WorksRes): string {
		return JSON.stringify(uncast(value, r('WorksRes')), null, 2);
	}
}
...
const typeMap: any = {
	WorksRes: o(
		[
			{ json: 'data', js: 'data', typ: a(r('Works')) },
	...
	Works: o(
		[
			{ json: 'id', js: 'id', typ: 0 },
			{ json: 'attributes', js: 'attributes', typ: r('Work') },
		],
		false,
	),
	Work: o(
