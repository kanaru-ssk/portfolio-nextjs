// To parse this data:
//
//   import { Convert, WorksPageRes } from "./file";
//
//   const welcome = Convert.toWorksPageRes(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface WorksPageRes {
  data: WorksPageResData;
  meta: Meta;
}

export interface WorksPageResData {
  id: number;
  attributes: WorksPage;
}
...
export class Convert {
  public static toWorksPageRes(json: string): WorksPageRes {
    return cast(JSON.parse(json), r("WorksPageRes"));
  }

  public static welcomeToJson(value: WorksPageRes): string {
    return JSON.stringify(uncast(value, r("WorksPageRes")), null, 2);
  }
}
...
const typeMap: any = {
  WorksPageRes: o(
    [
      { json: "data", js: "data", typ: r("WorksPageResData") },
  ...
  WorksPageResData: o(
    [
      { json: "id", js: "id", typ: 0 },
      { json: "attributes", js: "attributes", typ: r("WorksPage") },
    ],
    false
  ),
  WorksPage: o(
