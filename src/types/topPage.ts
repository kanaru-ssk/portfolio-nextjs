// To parse this data:
//
//   import { Convert, TopPageRes } from "./file";
//
//   const welcome = Convert.toTopPageRes(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface TopPageRes {
  data: TopPageResData;
  meta: Meta;
}

export interface TopPageResData {
  id: number;
  attributes: TopPage;
}
...
export class Convert {
  public static toTopPageRes(json: string): TopPageRes {
    return cast(JSON.parse(json), r("TopPageRes"));
  }

  public static welcomeToJson(value: TopPageRes): string {
    return JSON.stringify(uncast(value, r("TopPageRes")), null, 2);
  }
}
...
const typeMap: any = {
  TopPageRes: o(
    [
      { json: "data", js: "data", typ: r("TopPageResData") },
  ...
  TopPageResData: o(
    [
      { json: "id", js: "id", typ: 0 },
      { json: "attributes", js: "attributes", typ: r("TopPage") },
    ],
    false
  ),
  TopPage: o(
